...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--bw", dest="bw", action="store", default="50", help="the NIC bandwidth"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--hpai", dest="hpai", action="store", type=int, default=0, help="AI for HPCC"
    )
    parser.add_argument(
        "--pint_log_base",
        dest="pint_log_base",
    ...
    os.system('./ns3 run "scratch/third %s"' % (config_name))
